  ...
  projectData: [
    {
      ...
      image: {
        src: "./school/holidaze1.jpg",
        alt: "Holidaze website",
      },

      video: {
        src: "./videos/holidaze.mp4",
        poster: "./school/holidaze1.jpg",
      },
      id: "4",
      ...
      shortText:
        "React-based Airbnb-style booking app with roles for customers and managers, built as a final group exam project.",
    ...
    },
    {
      ...
      shortText:
        "React e-commerce store with search, product pages, cart, checkout, and contact form. Built for a course with responsive design.",
    ...
    },
    {
      ...
      shortText:
        "React + TypeScript auction app with real-time bidding, user accounts, and secure APIs. Solo semester project focused on quality.",
